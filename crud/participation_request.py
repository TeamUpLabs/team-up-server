...
from schemas.participation_request import ParticipationRequestCreate, ParticipationRequestUpdate
from crud.base import CRUDBase


class CRUDParticipationRequest(CRUDBase[ParticipationRequest, ParticipationRequestCreate, ParticipationRequestUpdate]):
    """Participation request model CRUD operations"""
    ...
    async def update_participation_request(
        ...
        db_request = await self.get_participation_request(db, request_id)
        if not db_request:
            return None
    ...
    def update_participation_request_sync(
        ...
        db_request = self.get_participation_request_sync(db, request_id)
        if not db_request:
            return None
...
# CRUDParticipationRequest class instance creation
